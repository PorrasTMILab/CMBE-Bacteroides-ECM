...
- **ECM protease families:** The same list of substrate terms was used to query the MEROPS database. All enzymes with recorded activity in the MEROPS database were retrieved and grouped by individual families.
...
| db_ECM_MEROPS_protease_families.xlsx | | | .xlsx | List of protease families documented in the MEROPS database with ECM substrate targets |
